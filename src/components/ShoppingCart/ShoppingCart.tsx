                    ...
                    <ul className={style.shoppingCartListItems}>
                        {items.map((item)=>
                            <li className={style.shoppingCartItem}>
                                ...
                                <div className={style.shoppingCartItemImg}>
                                    <img src={item.image} alt={item.title} />
                                </div>
                            
                                <div className={style.shoppingCartItemInfo} >
                                    <h4>{item.title}</h4>
                                    <p className={style.shoppingCartItemInfoPrice}>{`Price: $${item.price}`}</p> 
                                    <div className={style.shoppingCartItemQuantityControl}>
